      ...
      >
        <div className="container mx-auto px-4">
          ...
          <div className="lg:hidden flex justify-between items-center py-4">
            <div className={`font-[Koulen] text-2xl ${theme === "dark" ? "text-white" : "text-gray-900"}`}>
              ZeroDayCTF
            </div>
          ...
          >
            <div className="flex flex-col space-y-3 pb-4">
              {["/", "/challanges", "/leaderboard", "/about"].map((href) => (
                <Link
                  key={href}
                  href={href}
                ...
                >
                  {href === "/" ? "Home" : href.slice(1) === "challanges" ? "Challenges" : href.slice(1) === "leaderboard" ? "Leaderboard" : "About Us"}
                </Link>
              ))}
              {isLoggedIn && (
                <Link
